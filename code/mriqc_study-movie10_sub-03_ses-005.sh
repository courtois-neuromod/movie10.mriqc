...
#SBATCH --job-name=mriqc_study-movie10_sub-03_ses-005.job
#SBATCH --output=./code/mriqc_study-movie10_sub-03_ses-005.out
#SBATCH --error=./code/mriqc_study-movie10_sub-03_ses-005.err
#SBATCH --time=8:00:00
...
datalad containers-run -m 'mriqc_sub-03/ses-005' -n containers/bids-mriqc --input sourcedata/movie10/sub-03/ses-005/fmap/ --input sourcedata/movie10/sub-03/ses-005/func/ --output . -- -w workdir/ --participant-label 03 --session-id 005 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/movie10 ./ participant 
mriqc_exitcode=$?
