...
#SBATCH --job-name=mriqc_study-movie10_sub-05_ses-003.job
#SBATCH --output=./code/mriqc_study-movie10_sub-05_ses-003.out
#SBATCH --error=./code/mriqc_study-movie10_sub-05_ses-003.err
#SBATCH --time=8:00:00
...
datalad containers-run -m 'mriqc_sub-05/ses-003' -n containers/bids-mriqc --input sourcedata/movie10/sub-05/ses-003/fmap/ --input sourcedata/movie10/sub-05/ses-003/func/ --output . -- -w workdir/ --participant-label 05 --session-id 003 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/movie10 ./ participant 
mriqc_exitcode=$?
