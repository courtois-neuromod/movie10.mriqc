...
#SBATCH --job-name=mriqc_study-movie10_sub-04_ses-009.job
#SBATCH --output=./code/mriqc_study-movie10_sub-04_ses-009.out
#SBATCH --error=./code/mriqc_study-movie10_sub-04_ses-009.err
#SBATCH --time=8:00:00
...
datalad containers-run -m 'mriqc_sub-04/ses-009' -n containers/bids-mriqc --input sourcedata/movie10/sub-04/ses-009/fmap/ --input sourcedata/movie10/sub-04/ses-009/func/ --output . -- -w workdir/ --participant-label 04 --session-id 009 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/movie10 ./ participant 
mriqc_exitcode=$?
