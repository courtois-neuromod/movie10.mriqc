...
#SBATCH --job-name=mriqc_study-movie10_sub-01_ses-011.job
#SBATCH --output=./code/mriqc_study-movie10_sub-01_ses-011.out
#SBATCH --error=./code/mriqc_study-movie10_sub-01_ses-011.err
#SBATCH --time=8:00:00
...
datalad containers-run -m 'mriqc_sub-01/ses-011' -n containers/bids-mriqc --input sourcedata/movie10/sub-01/ses-011/fmap/ --input sourcedata/movie10/sub-01/ses-011/func/ --output . -- -w workdir/ --participant-label 01 --session-id 011 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/movie10 ./ participant 
mriqc_exitcode=$?
