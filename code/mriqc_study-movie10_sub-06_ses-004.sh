...
#SBATCH --job-name=mriqc_study-movie10_sub-06_ses-004.job
#SBATCH --output=./code/mriqc_study-movie10_sub-06_ses-004.out
#SBATCH --error=./code/mriqc_study-movie10_sub-06_ses-004.err
#SBATCH --time=8:00:00
...
datalad containers-run -m 'mriqc_sub-06/ses-004' -n containers/bids-mriqc --input sourcedata/movie10/sub-06/ses-004/fmap/ --input sourcedata/movie10/sub-06/ses-004/func/ --output . -- -w workdir/ --participant-label 06 --session-id 004 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/movie10 ./ participant 
mriqc_exitcode=$?
