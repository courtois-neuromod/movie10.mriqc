...
#SBATCH --job-name=mriqc_study-movie10_sub-03_ses-007.job
#SBATCH --output=./code/mriqc_study-movie10_sub-03_ses-007.out
#SBATCH --error=./code/mriqc_study-movie10_sub-03_ses-007.err
#SBATCH --time=8:00:00
...
datalad containers-run -m 'mriqc_sub-03/ses-007' -n containers/bids-mriqc --input sourcedata/movie10/sub-03/ses-007/fmap/ --input sourcedata/movie10/sub-03/ses-007/func/ --output . -- -w workdir/ --participant-label 03 --session-id 007 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/movie10 ./ participant 
mriqc_exitcode=$?
